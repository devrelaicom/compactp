...
the depth of the expression, type, statement and block nesting it builds, so
neither the parser nor a recursive consumer of the tree overflows the stack on
adversarial input.
